...
import com.mariodev.tracker_data.remote.malformedFoodResponse
import com.mariodev.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    @Test
    fun `Search food, invalid response, returns results failure`() = runBlocking {
        mockWebServer.enqueue(
    ...
    @Test
    fun `Search food, malformed response, returns results failure`() = runBlocking {
        mockWebServer.enqueue(
